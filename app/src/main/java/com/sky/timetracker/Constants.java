...
public class Constants {
    ...
    public static final String DATABASE_NAME = "timer_data.db";
    public static final int DATABASE_VESION = 3;
    public static final String TABLE_NAME_RECORD = "RECORD_DATA";
    public static final String TABLE_NAME_RECORD_TYPE = "RECORD_DATA_TYPE";
